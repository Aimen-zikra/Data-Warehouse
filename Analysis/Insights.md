...
|-------|----------|-----------------|
| **Total Revenue** | [`business metrics.sql`](./business metrics.sql) | `df['sales_amount'].sum()` |
| **Monthly Revenue & MoM Growth** | [`business metrics.sql`](./business metrics.sql) | `df.groupby('month')['sales_amount'].sum()` |
| **Top 10 Products by Revenue** | [`business metrics.sql`](./business metrics.sql) | `df.merge(products).groupby('product_name')...` |
